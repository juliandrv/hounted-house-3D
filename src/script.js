...
roofMesh.position.y = 2.5 + 0.75; // box height + roof half height
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    // Suggested code may be subject to a license. Learn more: ~LicenseLog:57795302.
 ...
 * Fog
 */
// scene.fog = new THREE.Fog("#ff0000", 10, 15);
